...
%                 fprintf('already in state %s\n', name);
        ...
        %   measured wheel encoder tick counts are stored in prev_ticks.
            ...
            %% START CODE BLOCK %%
            right_wheel_dist = m_per_tick * (right_ticks - prev_right_ticks); % Dr
            left_wheel_dist = m_per_tick * (left_ticks - prev_left_ticks); % Dl
            fprintf("Right: %0.3g, Left: %0.3g\n", right_wheel_dist, left_wheel_dist);
